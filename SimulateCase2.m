...
AttkScale=0.106/0.7935; %i'm supposed to hit 0.106 error in position in error for L=4
...
[x_ea,y_ea,ya_ea,x_hat_ea,u_ea,a_ea] = SimulateClosedLoopSystemV2GAasEA(A,B,C,Gatk,W,U,Q,R,x0,IsAttk,AtkDuration,AttkScale,refx,4);
beep
