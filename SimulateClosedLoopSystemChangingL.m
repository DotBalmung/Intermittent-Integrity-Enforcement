function [x,y,ya,x_hat,u,a] = SimulateClosedLoopSystemChangingL(A,B,C,Gatk,W,U,Q,R,x0,IsAttk,AtkDuration,AttkScale,reference,LsList,CC)
...
%   LsList: list (vector) of inter-authentication periods (L)
%   CC: Selector - 1 means cruise control case study, while in the case 0 
%       this function uses attacks for lane position tracking
% Outputs:
...
[~,a] = PlanAttackGAasEAchangingL(LsList,CC);
AtkDuration = length(a);
